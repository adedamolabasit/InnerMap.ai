...
export function DreamCapture({ onSave, onBack }: DreamCaptureProps) {
  ...
  const handleStartRecording = async () => {
    try {
      ...
      mediaRecorder.onstop = () => {
        ...
        const transcriptionDemo = 'I was walking through a forest... the trees were glowing... there was a path I needed to follow...'
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold text-foreground">Capture Your Dream</h1>
            <p className="text-muted-foreground">Record what you remember when you wake up</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`text-xs px-3 py-1 rounded-full ${
                    isRecording ? 'bg-destructive/20 text-destructive' : 'bg-muted'
                  }`}
                >
          ...
          <div className="space-y-4">
            <Card className="p-6 border-border bg-card space-y-4">
              <h3 className="font-semibold text-foreground">Tips for Better Recall</h3>
              <ul className="space-y-3 text-sm text-muted-foreground">
                ...
                <li className="flex gap-3">
                  <span className="text-primary">•</span>
                  <span>Include sensory details (colors, textures, sounds)</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-primary">•</span>
            ...
            <Card className="p-6 border-border bg-primary/5 space-y-3">
              <h3 className="font-semibold text-foreground text-sm">Word Count</h3>
              <p className="text-2xl font-bold text-primary">{dreamText.split(/\s+/).filter(Boolean).length}</p>
