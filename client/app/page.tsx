  ...
  const [dream, setDream] = useState<DreamResponse>(
{
    ...
    reflection: {
        ...
        insights: "This dream gently reflects your experience of being welcomed and valued but then losing your way due to distraction. It highlights your struggle to navigate external confusion and internal doubts, especially around whom to trust as you try to find your path back to a place of security or success. The interactions suggest a yearning for guidance balanced with awareness of deception or resistance from others, symbolizing a deeper exploration of self-trust and resilience.",
        suggested_action_hint: "Consider reconnecting with what grounds and centers you to regain focus, and gently explore where you may be feeling uncertain about whom or what to trust in your waking life."
    },
    action: {
        type: "reflect",
        content: "Consider exploring moments in your waking life where you feel disconnected or distracted. Reflect on how trust and skepticism currently influence your relationships, and how these feelings may shape your inner conflicts. This reflection may gently guide you to recognize where you desire more clarity or support.",
        agenticHooks: [
